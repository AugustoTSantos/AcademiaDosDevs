...
public class Aula08 {
    public static void main(String[] args) {
        double dado9Lados = 1 + (int) (Math.random() * 6); /*o metodo .random gera um número double aleatório entre 0 e 1
        ...
        System.out.println(dado9Lados); // imprimindo no console
        JOptionPane.showMessageDialog(null, dado9Lados); // abrindo uma janela com a impressão
